...
## UPD 🕊 on 2.12.0 (Update Height: 40511000) This is a chain update to version 2.12.0 with some security fixes and the end of Oracle support!!!
...
chmod +x ./nibid
rm nibid_2.12.0_linux_amd64.tar.gz
​
$HOME/nibiru/nibid version --long | grep -e version -e commit
# version: 2.12.0
# commit: 0df195c00524feb98bcf9106f224d35c26871da8
​
# AFTER THE NETWORK IS STOPPED ON THE REQUIRED BLOCK!!!
systemctl stop nibid
mv $HOME/nibiru/nibid $HOME/go/bin/
...
## UPD 🕊 on 2.14.0 (Update Height: 42125750)

```shell
cd $HOME/nibiru
wget https://github.com/NibiruChain/nibiru/releases/download/v2.14.0/nibid_2.14.0_linux_amd64.tar.gz
tar -zxvf nibid_2.14.0_linux_amd64.tar.gz
chmod +x ./nibid
rm nibid_2.14.0_linux_amd64.tar.gz
​
$HOME/nibiru/nibid version --long | grep -e version -e commit
# version: 2.14.0
# commit: 9fca51e7e5d80f734cb536b74c05624b6070067e
​
# AFTER THE NETWORK IS STOPPED ON THE REQUIRED BLOCK!!!
systemctl stop nibid
mv $HOME/nibiru/nibid $HOME/go/bin/
...
## UPD 🕊 on 2.15.0 (Update Height: 42739079)

```shell
cd $HOME/nibiru
wget https://github.com/NibiruChain/nibiru/releases/download/v2.15.0/nibid_2.15.0_linux_amd64.tar.gz
tar -zxvf nibid_2.15.0_linux_amd64.tar.gz
chmod +x ./nibid
rm nibid_2.15.0_linux_amd64.tar.gz
​
$HOME/nibiru/nibid version --long | grep -e version -e commit
# version: 2.15.0
# commit: dbdd54a6e32b64f5ad13528a53cb065ed3f819d9
​
# AFTER THE NETWORK IS STOPPED ON THE REQUIRED BLOCK!!!
systemctl stop nibid
mv $HOME/nibiru/nibid $HOME/go/bin/
...
## UPD 🕊 on 2.16.0 (Update Height: 42885000)

```shell
wget https://github.com/NibiruChain/nibiru/releases/download/v2.16.0/nibid_2.16.0_linux_amd64.tar.gz
tar -zxvf nibid_2.16.0_linux_amd64.tar.gz
chmod +x ./nibid
rm nibid_2.16.0_linux_amd64.tar.gz
​
$HOME/nibiru/nibid version --long | grep -e version -e commit
# version: 2.16.0
# commit: ac05154620fac185530daaec0c9dd59886e026cc
​
# AFTER THE NETWORK IS STOPPED ON THE REQUIRED BLOCK!!!
systemctl stop nibid
mv $HOME/nibiru/nibid $HOME/go/bin/
...
## UPD 🕊 on 2.17.0 (Update Height: 43464589)

```shell
wget https://github.com/NibiruChain/nibiru/releases/download/v2.17.0/nibid_2.17.0_linux_amd64.tar.gz
tar -zxvf nibid_2.17.0_linux_amd64.tar.gz
chmod +x ./nibid
