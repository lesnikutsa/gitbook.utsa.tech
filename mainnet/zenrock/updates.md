...
## UPD 🕊 on v6.54.0 (Update Height: 5274500)
...
## UPD 🕊 on v6.55.0 (Update Height: 5288500)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.55.0/zenrockd
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.55.0
...
## UPD 🕊 on v6.73.0 (Update Height: 5691580)
...
## UPD 🕊 on v6.91.0 (Update Height: 5691580)
...
## UPD 🕊 on v6.146.0 (Update Height: 6893300)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.146.0/zenrockd.zip
unzip zenrockd.zip
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.146.0
# commit: 3f693c2b2cbc06a93be78189c192ebd0ad7a5465
...
## UPD 🕊 on v6.50.0 (Update Height: 6927700)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.150.0/zenrockd.zip
unzip zenrockd.zip
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.150.0
# commit: 0be87931401008ca08cfe3972a78884f0e6b13a6
