...
#curl -L https://share101.utsa.tech/dymension/wasm-dymension.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.dymension --strip-components 2
```
...
```shell
SNAP_RPC=https://t-dymension.rpc.utsa.tech:443
