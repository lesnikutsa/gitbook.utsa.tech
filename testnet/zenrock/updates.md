...
## UPD 🕊 on v6.50.0 (Update Height: 2573250)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.50.0/zenrockd
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.50.0
# commit: ffce543337166e17fd16614b7d1f14829463edf3
...
## UPD 🕊 on v6.53.0 (Update Height: 2589200)

<pre class="language-shell"><code class="lang-shell"><strong>cd $HOME/zenrock
</strong>wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.53.0/zenrockd
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.53.0
# commit: fb4cc56bc94275251e7a9278caf0fcba9990db06
...
## UPD 🕊 on v6.55.0 (Update Height: 2621600)

<pre class="language-shell"><code class="lang-shell"><strong>cd $HOME/zenrock
</strong>wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.55.0/zenrockd
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.55.0
...
## UPD 🕊 on v6.85.0 (Update Height: 3264700)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.85.0/zenrockd.zip
unzip zenrockd.zip
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.85.0
# commit: dc8781ec700198a7838d702b48da63d299e31e43
...
## UPD 🕊 on v6.91.0 (Update Height: 3339500)

```shell
cd $HOME/zenrock
wget https://github.com/Zenrock-Foundation/zrchain/releases/download/v6.91.0/zenrockd.zip
unzip zenrockd.zip
chmod +x zenrockd
$HOME/zenrock/zenrockd version --long | grep -e version -e commit
# version: 6.91.0
